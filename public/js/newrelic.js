function newrelicNuxtIntegration() {
  if (window.location.hostname === 'localhost') {
    return;
  }

  const { newRelicAccountId, newRelicApplicationId, newRelicLicenseKey } = window.newRelicConfig;
      ...
      r = {
        5763: (e, t, r) => {
          ...
          const A = {
              ...
              maxBytes: 3e4,
              offset: Math.floor(
                w._A?.performance?.timeOrigin || w._A?.performance?.timing?.navigationStart || Date.now()
              ),
              onerror: void 0,
        ...
        8632: (e, t, r) => {
          ...
          function a() {
            return (
              i._A.NREUM || (i._A.NREUM = {}), void 0 === i._A.newrelic && (i._A.newrelic = i._A.NREUM), i._A.NREUM
            );
          }
          function s() {
            let e = a();
        ...
        importAggregator() {
          ...
          const o = async () => {
            ...
            try {
              ...
              (0, l.Z)('Downloading and initializing '.concat(this.featureName, ' failed...'), e),
                this.abortHandler?.(),
                n(!1);
            }
          };
            ...
            (n[g.Dz] = Math.max(Date.now() - n.offset, 0)),
              ...
              (0, f.b)(() => {
                ...
                (n[g.OJ] = Math.max(t - n[g.Dz], 0)),
                  (0, s.p)('timing', ['load', t], void 0, e.D.pageViewTiming, this.ee);
              });
          }
      ...
      try {
        (R = localStorage.getItem('__nr_flags').split(',')),
          console &&
            ...
            ((L.console = !0), -1 !== R.indexOf('dev') && (L.dev = !0), -1 !== R.indexOf('nr_dev') && (L.nrDev = !0));
      } catch (e) {}
      function z(e) {
        try {
          L.console && z(e);
      ...
      class B extends h {
        ...
        onerrorHandler(t, r, n, i, o) {
          ...
          try {
            this.skipNext
              ? (this.skipNext -= 1)
              : (0, s.p)('err', [o || new F(t, r, n), (0, p.z)()], void 0, e.D.jserrors, this.ee);
          } catch (t) {
            try {
              ...
              (function(r, n, i, o) {
                ...
                function w(e) {
                  ...
                  'string' == typeof e[0]
                    ...
                    : e[0] && e[0].url
                    ? (t = e[0].url)
                    : c._A?.URL && e[0] && e[0] instanceof URL && (t = e[0].href),
                ...
                function x(e, t) {
                  ...
                  'string' == typeof i
                    ...
                    ? (r = i.url)
                    : c._A?.URL && 'object' == typeof i && i instanceof URL && (r = i.href),
                    T(this, r);
                  ...
                  n.every((e) => r[e]) ||
                    (0, l.Z)(
                      ''
                        ...
                        .concat((0, D.P)(n), '). This may cause unintended consequences or missing data...')
                    ),
